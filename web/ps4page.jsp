...
<%
    ...
    for (int i = stories.length - 1; i >= 0; i--){
        if(stories[i].getPlatform() != null && stories[i].getPlatform().equals("PS4")){
            ps4Reviews = ps4Reviews + 1;
        }
    }
%>

<form action="ps4" method="post">
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="ps4">PS4</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="well well-sm">
                <h3><p class="text-primary"><%=ps4Reviews%> Review(s)</h3>
                        ...
                        <%
                            for (int i = stories.length - 1; i >= 0; i--) {
                                if (stories[i].getCommentOnStoryID() != 0)
                                    continue;
                                if(stories[i].getPlatform().equals("PS4")){
                        %>
            ...
            <div class="well well-sm">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" id="platform" name="platform" value="PS4">
