...
<form action="xbox360" method="post">
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="xbox360">Xbox 360</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="well well-sm">
                <h3><p class="text-primary"><%=xbox360Reviews%> Review(s)</h3>
            ...
            <div class="well well-sm">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" id="platform" name="platform" value="Xbox 360">
