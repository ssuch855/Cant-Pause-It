...
<%
    ...
    for (int i = stories.length - 1; i >= 0; i--){
        if(stories[i].getPlatform() != null && stories[i].getPlatform().equals("PS3")){
            ps3Reviews = ps3Reviews + 1;
        }
    }
%>

<form action="ps3" method="post">
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="ps3">PS3</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="well well-sm">
                <h3><p class="text-primary"><%=ps3Reviews%> Review(s)</h3>
                    ...
                    <ul class="list-group">
                        <%
                            for (int i = stories.length - 1; i >= 0; i--) {
                                ...
                                if(stories[i].getPlatform().equals("PS3")){
                        %>
            ...
            <div class="well well-sm">
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" id="platform" name="platform" value="PS3">
